...
@include('clinic.topmenu')	
    ...
    <form class="m-form m-form--fit m-form--label-align-right" action="{{url('/')}}/clinic/employees/edit/{{$id}}" method="post" enctype="multipart/form-data">
        {{csrf_field()}}
        <div class="m-portlet__body">
                    ...
                    <select class="form-control m-input m-input--solid" name="employee_type">
                      <option disabled >
                        ...
                        @foreach($user_type as $k=>$t)
                        @if($userinfo->employeetype ==$k )
