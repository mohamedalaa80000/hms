...
@include('clinic.topmenu')
    ...
    <form class="m-form m-form--fit m-form--label-align-right" action="{{url('/')}}/clinic/employees/add" method="post" enctype="multipart/form-data">
        {{csrf_field()}}
        <div class="m-portlet__body">
                    ...
                    <select class="form-control m-input m-input--solid" name="employee_type">
                        ...
                        <div class="has-danger">
                            ...
                            @foreach($errors->get('employee_type') as $er)
                                {{$er}}
                                @endforeach
                            </div></div>
                        @endif  
                    ...
                    <select class="form-control m-input m-input--solid" name="work_day">
                     
                        <option value="{{$singleormulti->onlyday}}" selected>{{$weeks[$singleormulti->onlyday]}}</option>

                    </select>
                                @if($errors->has('work_day'))
                        <div class="has-danger">
                            <div class="form-control-feedback">
                            @foreach($errors->get('work_day') as $er)
                                {{$er}}
                                @endforeach
                            </div></div>
                        @endif  
                </div>
                       @elseif($singleormulti->singleormulti == 0)
                        <div class="form-group m-form__group " >
                                                  <label>
                        Work Start
                    </label>
                  <select class="form-control m-input m-input--solid" name="work_start">
                     ...
                     @foreach($startdays as $r)
                      <option value="{{$weeksnum[$r]}}">{{$weeks[$weeksnum[$r]]}}</option>
                      @endforeach
                     </select>
                  ...
                  <select class="form-control m-input m-input--solid" name="work_end">
                        <option selected="" disabled="">Select End Date</option>
                      @foreach($startdays as $r)
                      <option value="{{$weeksnum[$r]}}">{{$weeks[$weeksnum[$r]]}}</option>
                      @endforeach
                            </select>
