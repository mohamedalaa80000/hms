...
@include('admin.topmenu')	
			...
			<div class="m-grid__item m-grid__item--fluid m-grid m-grid--ver-desktop m-grid--desktop m-body">
				...
				<div class="m-grid__item m-grid__item--fluid m-wrapper">
				 ...
				 <div class="m-alert m-alert--outline m-alert--outline-2x alert alert-success alert-dismissible fade show" role="alert">
													...
													You successfully Added New Clinic.
												</div>
                            @endif
					</div>
					<!-- END: Subheader -->
    ...
    <form class="m-form m-form--fit m-form--label-align-right" method="post" action="{{url('/')}}/admin/clinics/add" >
        {{csrf_field()}}
        <div class="m-portlet__body">
                   ...
                   <input class="form-control m-input m-input--solid" type="text" name="clinic_name" value="{{old('clinic_name')}}">
                  ...
                  <select class="form-control m-input m-input--solid" id="singleday" name="signle_or_multi">
                        ...
                        @endif 
                           ...
                           <div class="form-group m-form__group hides_day_work">
                               ...
                               <style>.hides_day_work{display:block!important;}</style>
                      ...
                      <option value="6">Friday</option>
                        ...
                        @endif 
                           ...
                           <div class="form-group m-form__group hides_work_start">
                               @if($errors->has('day_work'))
                               <style>.hides_work_start{display:none!important;}</style>
                      ...
                      <option value="6">Friday</option>
                        ...
                        @endif 
                           ...
                           <div class="form-group m-form__group hides_work_end">
                                @if($errors->has('day_work'))
                               <style>.hides_work_end{display:none!important;}</style>
