...
@include('admin.topmenu')	
    ...
    <form class="m-form m-form--fit m-form--label-align-right" action="{{url('/')}}/admin/employees/edit/{{$id}}" method="post" enctype="multipart/form-data">
        {{csrf_field()}}
        <div class="m-portlet__body">
                    ...
                    <select class="form-control m-input m-input--solid" name="employeetype">
                        ...
                        <option value="2" >Receptionist</option>
                        <option value="3" >Accountant</option>
                        <option value="4" selected>X-Ray Employees</option>
                        <option value="5">Warehouse Employees</option>
                        @endif
                        @if($userinfo->employeetype == 5)
                       <option disabled >
                            Select Type
                        </option>
                        <option value="0" >Doctor</option>
                        ...
                        <option value="3" >Accountant</option>
                        <option value="4" >X-Ray Employees</option>
                        <option value="5" selected>Warehouse Employees</option>
                        @endif
