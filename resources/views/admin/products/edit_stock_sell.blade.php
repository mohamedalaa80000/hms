...
@include('admin.topmenu')	
						...
						<div class="d-flex align-items-center">
                         ...
                         @if(session()->get('updated') != null and session()->get('updated') == 1)
                                 <div class="m-alert m-alert--outline m-alert--outline-2x alert alert-success alert-dismissible fade show" role="alert">
													...
													You successfully Updated Product Purchase Sell.
												</div>
                                @endif
					</div>
					<!-- END: Subheader -->
    ...
    <form class="m-form m-form--fit m-form--label-align-right" action="/admin/products/stock_sell_entries/edit/{{$stockinfo->id}}" method="post">
        {{csrf_field()}}
        <div class="m-portlet__body">
            ...
            <input class="form-control m-input m-input--solid" type="number" name="price" value="{{$stockinfo->price}}">
                  ...
                  <select class="form-control m-input m-input--solid" name="clinic">
                      ...
                      @if($cl->id == $stockinfo->clinicid)
                       <option value="{{$cl->id}}" selected>{{$cl->clinicname}}</option>
                     @else
