...
@include('receptionist.topmenu')	
    ...
    <form class="m-form m-form--fit m-form--label-align-right" action="{{url('/')}}/receptionist/services/add" method="post">
        {{csrf_field()}}
        <div class="m-portlet__body">
                   ...
                   <select class="form-control m-input m-input--solid" name="clinic" id="addserclinic">
                        
                      <option selected disabled>Select Clinic</option>
                         @foreach($getallclinics as $d)
                       <option value="{{$d->id}}">{{$d->clinicname}}</option>
                       @endforeach
                    </select>
                   ...
                   <select class="form-control m-input m-input--solid" name="doctor" id="doctors">
                        
                      <option selected disabled>Select Clinic First</option>
                    </select>
